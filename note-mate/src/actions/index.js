import noteSample from "../Notes.js";
...
export const getNotes = () => {
  var notes = new Promise(function(resolve, reject) {
    resolve(console.log("Fetch Note Promise", atNote));
  });
  return dispatch => {
    dispatch({ type: RECIEVING_NOTES });
    notes
      .then(() => {
        dispatch({ type: NOTES_RECEIVED, payload: atNote });
      })
      .catch(err => {
...
export const createNote = note => {
  ...
  return dispatch => {
    ...
    newNote
      .then(() => {
        console.log("in actions => NOTES CREATED: ", atNote);
...
export const updateNote = updates => {
  var updatedNote = new Promise(function(resolve, reject) {
    ...
    console.log("The update", currentNotes);
  ...
  return dispatch => {
    ...
    updatedNote
      .then(data => {
        console.log("Update Note inside then", data);
